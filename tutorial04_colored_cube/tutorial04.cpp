...
int main( void )
{
    ...
    glm::mat4 View2       = glm::lookAt(
                                       glm::vec3(12,13,-9), // Camera is at (4,3,-3), in World Space
...
//	glm::mat4 MVP2        = Projection * View2 * Model; // Remember, matrix
...
//	};
	...
	do{
        ...
        for (int v=0; v < 12*3*3; v++) {
            g_color_buffer_data[v]= rand()%1000 / 1000.0f;
        }
        GLuint colorbuffer;
